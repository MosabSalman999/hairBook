...
fun AdminScreen(modifier: Modifier = Modifier) {
    Scaffold(
        ...
        topBar = { HairBookTopBar(title = stringResource(R.string.admin_title)) }
    ) { innerPadding ->
        Column(
            modifier = Modifier
            ...
            Text(text = stringResource(R.string.admin_placeholder), style = MaterialTheme.typography.bodyMedium)
        }
    }
}
